package com.hp.android.angel.arcoreexample.feature
...
import com.hp.android.angel.arcoreexample.R
...
class MyRoomActivity : AppCompatActivity() {
    ...
    private fun showFab(enabled: Boolean) {
        if (enabled) {
            tvActionButton.isEnabled = true
            tvActionButton.visibility = View.VISIBLE
            ovenActionButton.isEnabled = true
            ovenActionButton.visibility = View.VISIBLE
            tableActionButton.isEnabled = true
            tableActionButton.visibility = View.VISIBLE
            couchActionButton.isEnabled = true
            couchActionButton.visibility = View.VISIBLE
        } else {
            tvActionButton.isEnabled = true
            tvActionButton.visibility = View.GONE
            ovenActionButton.isEnabled = true
            ovenActionButton.visibility = View.GONE
            tableActionButton.isEnabled = true
            tableActionButton.visibility = View.GONE
            couchActionButton.isEnabled = true
            couchActionButton.visibility = View.GONE
        }
    }
    ...
    private fun placeObject(fragment: ArFragment, anchor: Anchor, model: Uri) {
        ModelRenderable.builder()
                ...
                .exceptionally {
                    Toast.makeText(this@MyRoomActivity, "Error", Toast.LENGTH_SHORT).show()
